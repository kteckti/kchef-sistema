...
export default function HomePage() {
  return (
    <>
      ...
      <main>
        {/* HERO SECTION */}
        <section className="hero-section text-center d-flex align-items-center" id="home" style={{ minHeight: '100vh' }}>
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-10">
                        ...
                        <a href="https://wa.me/5515996641070?text=Ol%C3%A1%20Kteck!%20Desejo%20saber%20mais%20sobre%20os%20servi%C3%A7os" className="btn btn-custom btn-lg" target="_blank">Fale com um Especialista</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div className="container py-lg-5">
                <div className="row align-items-center">
                    <div className="col-lg-6 mb-4 mb-lg-0">
                        ...
                        <Link href="/servicos" className="btn btn-custom mt-3">Conheça nossos serviços</Link>
                    </div>
                    <div className="col-lg-6">
                        <img src="/assets/img/rm407-124.jpg" className="img-fluid rounded shadow-lg" alt="Consultoria de TI Kteck" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="py-5" id="beneficios">
            <div className="container py-lg-5">
                <div className="text-center mb-5">
                    <p className="text-uppercase text-info fw-bold mb-2">Benefícios</p>
                    <h2 className="fw-bold text-white">Por que escolher a Kteck Solutions?</h2>
                </div>
                <div className="row g-4">
                    <div className="col-md-6 col-lg-3">
                        <div className="feature-box text-center h-100 shadow-sm">
                            <div className="feature-icon mb-3"><i className="fa-solid fa-headset text-primary"></i></div>
                            <h4 className="fw-bold">Suporte 24/7</h4>
                    ...
                    <div className="col-md-6 col-lg-3">
                        <div className="feature-box text-center h-100 shadow-sm">
                            <div className="feature-icon mb-3"><i className="fa-solid fa-user-tie text-primary"></i></div>
                            <h4 className="fw-bold">Consultoria Especializada</h4>
                    ...
                    <div className="col-md-6 col-lg-3">
                        <div className="feature-box text-center h-100 shadow-sm">
                            <div className="feature-icon mb-3"><i className="fa-solid fa-chart-line text-primary"></i></div>
                            <h4 className="fw-bold">Escalabilidade</h4>
                    ...
                    <div className="col-md-6 col-lg-3">
                        <div className="feature-box text-center h-100 shadow-sm">
                            <div className="feature-icon mb-3"><i className="fa-solid fa-shield-halved text-primary"></i></div>
                            <h4 className="fw-bold">Segurança Avançada</h4>
        ...
        {/* ESTATÍSTICAS */}
        <section className="dark-section text-center py-5">
            <div className="container py-lg-4">
                <h2 className="mb-5 fw-bold">Por que a Kteck é a parceira ideal?</h2>
                <div className="row g-4">
                    ...
                    <div className="col-md-3">
                        ...
                        <p className="mb-0">Projetos de redes</p>
                    </div>
                    <div className="col-md-3">
                        <div className="stat-number">+10</div>
                        <p className="mb-0">Fornecedores Parceiros</p>
                    </div>
                    <div className="col-md-3">
                        <div className="stat-number">+100</div>
                        <p className="mb-0">Empresas satisfeitas</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="py-5" id="servicos">
            <div className="container py-lg-5">
                <div className="d-flex justify-content-between align-items-center mb-5">
                    <h2 className="fw-bold text-white mb-0">Nossos Serviços</h2>
                    <Link href="/servicos" className="btn btn-outline-light rounded-pill px-4">
                        Ver todos
                    </Link>
                </div>
                ...
                >
                    <SwiperSlide>
                        <div className="service-card h-100 shadow-lg">
                            ...
                            <div className="service-content p-4">
                                ...
                                <Link href="/servicos" className="btn btn-outline-primary btn-sm rounded-pill mt-2 px-3">Saber Mais</Link>
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div className="service-card h-100 shadow-lg">
                            ...
                            <div className="service-content p-4">
                                <h5 className="fw-bold">Outsourcing de TI</h5>
                                <p className="small text-muted">Atuamos no suporte, monitoramento e manutenção dos ambientes de TI com foco em disponibilidade.</p>
                                <Link href="/servicos" className="btn btn-outline-primary btn-sm rounded-pill mt-2 px-3">Saber Mais</Link>
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div className="service-card h-100 shadow-lg">
                            ...
                            <div className="service-content p-4">
                                <h5 className="fw-bold">Segurança da Informação</h5>
                                <p className="small text-muted">Atuamos na prevenção, detecção e resposta a ameaças digitais para proteger o seu negócio.</p>
                                <Link href="/servicos" className="btn btn-outline-primary btn-sm rounded-pill mt-2 px-3">Saber Mais</Link>
                            </div>
                        </div>
                    </SwiperSlide>
